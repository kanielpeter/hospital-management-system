...
<head>
    ...
    <title> Psycholog Medical Hospital Website</title>
...
<body>
     ...
     <div class="slider">
        ...
        <div class="owl-carousel ">
            <div class="slider-img">
                <div class="item">
                    <div class="slider-img"><img src="assets/images/slider/slider-1.jfif" alt=""></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="slider-captions">
                                    ...
                                    <a href="bookappointments.html" class="btn btn-success hidden-xs">View All Therapies</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                ...
                                <p class="slider-text hidden-xs">We can help you conquer a wide range of psychological and emotional problems.</p>
                                <a href="bookappointments.html" class="btn btn-success hidden-xs">Schedule A Visit</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="slider-img"> <img src="assets/images/slider/slider-3.jfif" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                ...
                                <a href="bookappointments.html" class="btn btn-success hidden-xs">Meet Psychiatrists</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 doc-img">
                        <img  src="assets/images/doctt.jpeg" alt="">
                    </div>
                    <div class="col-md-6 col-sm-12 doc-det">
                        <h2>Hello, I’m Doctor Kinyua</h2>
                        <span>Expert Clinical Psychology in Narobi</span>
  	            ...
  	            <div class="col-md-4 col-sm-6">
  	                <div class="single-sess sess-ok">
  	                   <h4>Start Your Session today</h4>
  	                    ...
  	                    <button class="btn btn-success"><a href="login.php">Book an Appointment</a></button>
  	                </div>
  	            </div>
  	        </div>
  	    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 map-img">
                    ...
                    <address class="md-margin-bottom-40">
                        Pinnacle Towers Complex  <br>
                        Moi Avenue<br>
                        Nairobi, KEN<br>
                        Phone: +254722870015 <br>
    ...
    <div class="copy">
            <div class="container">
                <a href="https://www.smarteyeapps.com/">2021 &copy; All Rights Reserved | Designed and Developed by NelsonCo</a>
